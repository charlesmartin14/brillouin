...
$$Power=Rate*Decay Energy=\Gamma_{EC}*Q$$
...
$$P_{pe}=Re[\mathbb{C}^{2}]\left[(\mathbf{E}_{e}-m_{e})+(\mathbf{E}_{p}-M_{p})\right]\left(\mathcal{F}\right)$$

$$P_{n}=Re[\mathbb{C}^{2}]\left[2.2+(\mathbf{E}_{n}-M_{n})\right]\left(\mathcal{F}\right)$$
