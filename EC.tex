...
and the 16 allowed spin transitions (see figure below), averaging over the outbound neutrino momenta solid angle ($k^{3}d\Omega_k$) using an 8-point gaussian quadrature. 
