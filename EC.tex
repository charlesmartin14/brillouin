...
The Power $\mathcal{P}$ is just the capture rate time the nuclear "decay energy", or

$$\mathcal{P}=\Gamma_{EC}*Q*\rho$$

where $Q$ is the nuclear 'decay energy', or Q-value, and $\rho$ is the  density of confined elements.
