...
[[I don't have a great reference for this that has Ricks convention, and the orbital Ec papers I do have use a different convention]]
...
$$\bar{u}(p_{n},1)u(p_{p},1)\bar{u}(p_{k},2)u(p_{e},2)$$
$$\bar{u}(p_{n},2)u(p_{p},2)\bar{u}(p_{k},1)u(p_{e},1)$$
$$\bar{u}(p_{n},2)u(p_{p},1)\bar{u}(p_{k},2)u(p_{e},2)$$
$$\bar{u}(p_{n},1)u(p_{p},2)\bar{u}(p_{k},2)u(p_{e},1)$$



[[similar to diagram in "Beta Decay for Pedestrians"; it would be nice to work this out]]
