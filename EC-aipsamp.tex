...
To give a textual citation, use \verb+\onlinecite{#1}+: (Refs.~\onlinecite{alvarez,wang, martin}). 
...
To illustrate, we cite several together \cite{alvarez,wang, martin}, 
and once again (Refs.~\onlinecite{alvarez,wang, martin}). 
