...
\author{Charles H. Martin}
 \affiliation{Anthropocene Institute.}%Lines break automatically or can be forced with \\
  \email{charles@anthinst.org}
\author{Robert Godes}%with 
 \email{reg@brillouinenergy.com}
\affiliation{ 
Brilloiun Energy%\\This line break forced with \textbackslash\textbackslash
}%
...
%Here, our thought experiment is somewhat contrived, and is meant simply to illustrate how to perform the E.C. calculation in it's simplest but complete form.
...
It is well know that intense laser radiation can increase the effective mass of an electron.  This effect can also be used to enhance the E.C. rate.

It is easy to see the mass increase from the relativistic energy-momentum relation ($p_{\mu}p^{\mu}=m_{e}^{2},\;c=1$). in the presence of strong electromagnetic field.  
