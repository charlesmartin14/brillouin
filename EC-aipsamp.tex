...
The Weak Interaction describes several related , semi-leptonic processes (those involving leptons) within a single framework \cite{langanke}.  \emph{Neutron-rich} nuclei may become more stable as a result by undergoing one or more of the following:
