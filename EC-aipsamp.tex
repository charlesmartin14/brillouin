...
=293K$), which is anomalously small \cite{ferguson}.  
 ...
 This naturally leads to the following pedagogic question; what level of proton confinement is be necessary to induce a bare electron-proton capture event? Obviously we can estimate the box size from the uncertainty principle.  
