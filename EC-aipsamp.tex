...
If we include the vector potential ($A_{\mu}\;,c=e=1$) of the field in the momentum, we get the Hamilton-Jacobi equation
...
In the case of a constant intensity laser field  (i.e. $\mathbf{A}^{2}(x,t)\sim N$),  they derive an effective mass for an atomic electron using a 
