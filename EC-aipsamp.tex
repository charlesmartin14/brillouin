...
Note, however,  for relativisitic calculations, one uses the \emph{reduced} Compton wavelength $\lambda^{red}_{e}=\dfrac{\lambda^{red}_{e}}{2\pi}\sim\mathcal{O}(0.4\times 10^{-12}m$.  Thus, for an electron, the minimum L is on the order of 0.004 Angstrom 
